...
export function createExportRender(app) {
  function buildExportFolderRows(files = []) {
    return files.length
      ...
      : `<div class="export-folder-row"><div class="export-folder-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg></div><div style="flex:1;min-width:0"><div class="export-folder-name">No export files available</div><div class="export-folder-sub">Run the pipeline to generate data/outputs/by_location files.</div></div></div>`;
  }
